...
# common.pm
#
# Copyright (C) 2010-2014,2017,2019-2021,2023-2026 Oliver Hamann.
#
...
$V{'DEB_BUILD_DEPENDS'}=
	...
	'libpoppler-glib-dev, libgtk-3-dev, libfreetype6-dev';
$V{'DEB_DEPENDS'}=
	'perl, xterm, libc6, libgcc1, libstdc++6, libx11-6, '.
	'libjpeg62-turbo | libjpeg62, libpng16-16, libvlc5, '.
	'vlc-plugin-base, librsvg2-2, libpoppler-glib8, libgtk-3-0, '.
	'libfreetype6';
$V{'DEB_RECOMMENDS'}=
	'7z, abiword, bzip2, htmldoc, libwebp7, libtiff6, netpbm, pigz, tar';
...
$V{'RPM_BUILD_REQUIRES'}=
	"gcc-c++ perl\n".
	"\%if 0\%{?suse_version}\n".
	"BuildRequires: libX11-devel vlc-devel libjpeg62-devel libpng16-devel libtiff-devel libwebp-devel librsvg2-devel gtk3-devel libpoppler-glib-devel freetype-devel\n".
	"\%else\n".
	"BuildRequires: libX11-devel vlc-devel libjpeg-devel libpng-devel libtiff-devel libwebp-devel librsvg2-devel gtk3-devel poppler-glib-devel freetype-devel\n".
	"\%endif\n";
$V{'RPM_REQUIRES'}=
	"perl xterm\n".
	"\%ifarch x86_64\n".
...
$V{'EBUILD_SRC_URI'}='http://prdownloads.sourceforge.net/${PN}/${P}.tar.xz';
