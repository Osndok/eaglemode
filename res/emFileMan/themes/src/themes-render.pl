...
# Configuration
my $SrcFile             = 'themes.blend';
my $OutDir              = 'themes-rendered.tmp';
my $RenderResolutionX   = 2500;
my $RenderResolutionY   = 2500;
my $RenderPercentage    = 100;
my $PreRenderPercentage = 20;
my $RenderTileX         = 250;
my $RenderTileY         = 250;
my $RenderDevice        = 'GPU';
my $RenderSamples       = 50000;
...
sub RenderScene
{
	...
	my $tmpFileTmpl="/tmp/themes-render-$$-####.png";
	my $tmpFile    ="/tmp/themes-render-$$-0000.png";
