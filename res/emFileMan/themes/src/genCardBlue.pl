	...
	# Arguments: tallness, display name, display icon, file
{
	...
	my $BackgroundColor = '{215 215 222}';
	my $SourceSelectionColor = '{158 232 168}';
	my $TargetSelectionColor = '{254 153 167}';
	my $NormalNameColor = '{28 29 37}';
	my $ExeNameColor = '{0 90 0}';
	my $DirNameColor = '{0 33 155}';
	...
	my $PathColor = '{77 79 97}';
	my $SymLinkColor = '{69 138 138}';
	my $LabelColor = '{147 149 170}';
	my $InfoColor = '{116 118 140}';
	my $FileContentColor = '{215 215 222}';
	my $DirContentColor = '{119 138 177}';
