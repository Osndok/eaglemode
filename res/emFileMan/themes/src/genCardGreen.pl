	...
	# Arguments: tallness, display name, display icon, file
{
	...
	my $BackgroundColor = '{216 218 198}';
	my $SourceSelectionColor = '{164 233 160}';
	my $TargetSelectionColor = '{254 164 154}';
	my $NormalNameColor = '{26 25 23}';
	my $ExeNameColor = '{0 95 20}';
	my $DirNameColor = '{21 55 142}';
	my $FifoNameColor = '{221 0 139}';
	my $BlkNameColor = '{126 82 0}';
	my $ChrNameColor = '{83 99 0}';
	my $SockNameColor = '{191 18 191}';
	my $OtherNameColor = '{176 22 0}';
	my $PathColor = '{83 85 77}';
	my $SymLinkColor = '{66 133 133}';
	my $LabelColor = '{134 137 124}';
	my $InfoColor = '{117 120 111}';
	my $FileContentColor = '{216 218 198}';
	my $DirContentColor = '{94 144 150}';
