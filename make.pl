...
my $UniccREADME = catfile($UniccDir,"README");
	...
	# Returns: none
{
	print(
		...
		"        refer to the section \"Compilers\" in $UniccREADME.\n".
	...
	# Results: none
{
	...
	if ($Config{'osname'} eq "cygwin") {
		print(
			...
			"*** rebase all the Cygwin DLL's together with the DLL's built by this ***\n".
